...
public class DataMapper {
    ...
    public Customer toEntity(CustomerDTO dto) {
        return new Customer(dto.getId(), dto.getName(), dto.getLastName(), dto.getDocument(), dto.getEmail());
    }

    public CustomerDTO toDto(Customer customer) {
        return new CustomerDTO(customer.getId(), customer.getName(), customer.getLastName(), customer.getDocument(), customer.getEmail());
    }
