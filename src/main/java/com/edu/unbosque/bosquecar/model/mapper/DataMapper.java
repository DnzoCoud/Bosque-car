...
public class DataMapper {
    ...
    public Customer toEntity(CustomerDTO dto) {
        return new Customer(dto.getId(), dto.getCedula(), dto.getName(), dto.getLastName(), dto.getEmail());
    }

    public CustomerDTO toDto(Customer customer) {
        return new CustomerDTO(customer.getId(), customer.getCedula(), customer.getName(), customer.getLastName(), customer.getEmail());
    }
